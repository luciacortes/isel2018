...
#define PanSource	"lampara_code.pml"
...
#define _nstates1	8	/* entorno */
#define minseq1	24
#define maxseq1	30
#define _endstate1	7

#define _nstates0	25	/* lampara_code_fsm */
#define minseq0	0
#define maxseq0	23
...
#define Plampara_code_fsm	((P0 *)this)
typedef struct P0 { /* lampara_code_fsm */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
