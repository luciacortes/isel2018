...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 9: // STATE 27 - _spin_nvr.tmp:20 - [-end-] (0:0:0 - 1)
		...
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC lampara_fsm */
	case 10: // STATE 1 - alarm_code.pml:10 - [state = OFF] (0:0:1 - 1)
		IfNotBlocked
		reached[0][1] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 11: // STATE 2 - alarm_code.pml:12 - [((state==OFF))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][2] = 1;
		if (!((((int)now.state)==3)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 12: // STATE 3 - alarm_code.pml:14 - [(button)] (26:0:2 - 1)
		IfNotBlocked
		reached[0][3] = 1;
		if (!(((int)now.button)))
			continue;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 13: // STATE 9 - alarm_code.pml:17 - [((state==ON))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][9] = 1;
		if (!((((int)now.state)==2)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 14: // STATE 10 - alarm_code.pml:19 - [(button)] (26:0:2 - 1)
		IfNotBlocked
		reached[0][10] = 1;
		if (!(((int)now.button)))
			continue;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 15: // STATE 17 - alarm_code.pml:22 - [.(goto)] (0:26:0 - 2)
		IfNotBlocked
		reached[0][17] = 1;
		;
		/* merge: .(goto)(0, 27, 26) */
		...
		;
		_m = 3; goto P999; /* 1 */
	case 16: // STATE 13 - alarm_code.pml:20 - [(detector)] (26:0:2 - 1)
		IfNotBlocked
		reached[0][13] = 1;
		if (!(((int)now.detector)))
			continue;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 17: // STATE 19 - alarm_code.pml:23 - [((state==SONANDO))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][19] = 1;
		if (!((((int)now.state)==1)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 18: // STATE 20 - alarm_code.pml:25 - [(button)] (26:0:2 - 1)
		IfNotBlocked
		reached[0][20] = 1;
		if (!(((int)now.button)))
			continue;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 19: // STATE 29 - alarm_code.pml:29 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[0][29] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
