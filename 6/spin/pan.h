...
#define _nstates2	28	/* spec */
#define minseq2	37
#define maxseq2	63
#define _endstate2	27

#define _nstates1	9	/* entorno */
#define minseq1	29
#define maxseq1	36
#define _endstate1	8

#define _nstates0	30	/* lampara_fsm */
#define minseq0	0
#define maxseq0	28
...
#define Plampara_fsm	((P0 *)this)
typedef struct P0 { /* lampara_fsm */
	unsigned _pid : 8;  /* 0..255 */
	unsigned _t   : 3; /* proctype */
	unsigned _p   : 6; /* state    */
#ifdef HAS_PRIORITY
